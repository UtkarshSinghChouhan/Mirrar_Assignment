...
export default function Home() {
  ...
  return (
    <>
      <section className="mx-auto my-4 py-5 px-32 max-w-screen-lg w-fit h-fit shadow-xl shadow-gray-400 bg-gradient-to-br  from-violet-300 to-pink-300 flex flex-col justify-center text-slate-700">
